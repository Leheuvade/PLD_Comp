 ...
 */
class  IRVisitor : public grammaireBaseVisitor {
public:

  virtual antlrcpp::Any visitEntree(grammaireParser::EntreeContext *ctx) override {
    Programme* p= (Programme*)ctx->programme();
